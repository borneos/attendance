        ...
        <div class="row">
            ...
            <div class="form-holder">
                <div class="form-content"
                    style="background-image: url(https://res.cloudinary.com/borneos-co/image/upload/v1667649082/images/bg-drone-malahing_sfhrqg.webp);background-position: center;background-repeat: no-repeat;background-size: cover;">
                        ...
                        <form>
                            ...
                            <div class="form-button">
                                <button id="submit" type="submit" class="ibtn">Login</button> <a
                                    href="forget18.html">Forget password?</a>
                            </div>
                        </form>
